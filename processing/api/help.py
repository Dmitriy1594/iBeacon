...
@router.post(f"{PATH_TO_API}" + "/users/", response_model=schemas.User)
...
@router.post(f"{PATH_TO_API}" + "/users/{user_id}/items/", response_model=schemas.Item)
...
@router.get(f"{PATH_TO_API}" + "/items/", response_model=List[schemas.Item])
